...
<tbody>
    ...
    @forelse($results as $key => $result)
        <tr>
            ...
            @if($result->complaint_type == "general")
            <td><span class="label label-success">@lang('view_pages.general')</span></td>
            @else
            <td><span class="label label-danger">@lang('view_pages.request_help')</span></td>
            @endif
            <td>
