...
* copy the sheet id & place it in to Configuration->System settings menu update Map settings file with below param

  ![image](../../images/user-manual-docs/map_key.png)
