...
After createing the vehicle types & zone we need to set price for vehicle types each zone.
...
## Create Rental Package Name and Assign Pricing for Rental Package

After creating the vehicle fare, we need to assign the rental package price for each vehicle type.
While assigning the rental packages to the particular vehicle type, show rental ride vehicles in the application.

![image](../../images/user-manual-docs/rental-package-types.png)
![image](../../images/user-manual-docs/assign-rental-package.png)
![image](../../images/user-manual-docs/assign-rental-package1.png)
